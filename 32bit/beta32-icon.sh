#!/bin/sh
#
# This script uses echo to generate a icon shortcut file. - Mozilla Thunderbird 32-bit - beta release
#
# Creating icon
echo "[Desktop Entry]
...
Exec=/opt/thunderbird-beta-32bit/thunderbird/thunderbird %u --class ThunderbirdBeta32
Icon=/opt/thunderbird-beta-32bit/thunderbird/chrome/icons/default/default256.png
Terminal=false
Type=Application
...
Name[zh_CN]=编写新消息
Name[zh_TW]=寫一封新訊息
Exec=/opt/thunderbird-beta-32bit/thunderbird/thunderbird -compose %u --class ThunderbirdBeta32
...
Name[zh_CN]=打开通讯录
Name[zh_TW]=開啟通訊錄
Exec=/opt/thunderbird-beta-32bit/thunderbird/thunderbird -addressbook %u --class ThunderbirdBeta32" > Thunderbird-Beta-32bit.desktop ;
# Exit
exit 0
