...
Exec=/opt/thunderbird-daily-32bit/thunderbird/thunderbird %u --class ThunderbirdDaily32
Icon=/opt/thunderbird-daily-32bit/thunderbird/chrome/icons/default/default256.png
Terminal=false
Type=Application
...
Name[zh_CN]=编写新消息
Name[zh_TW]=寫一封新訊息
Exec=/opt/thunderbird-daily-32bit/thunderbird/thunderbird -compose %u --class ThunderbirdDaily32
...
Name[zh_CN]=打开通讯录
Name[zh_TW]=開啟通訊錄
Exec=/opt/thunderbird-daily-32bit/thunderbird/thunderbird -addressbook %u --class ThunderbirdDaily32" > Thunderbird-Daily-32bit.desktop ;
# Exit
exit 0
