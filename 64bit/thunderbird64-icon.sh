#!/bin/sh
#
# This script uses echo to generate a icon shortcut file. - Mozilla Thunderbird - current stable release
#
# Creating icon
echo "[Desktop Entry]
Name=Thunderbird
...
Exec=/opt/thunderbird/thunderbird %u --class MozillaThunderbird
...
Name[zh_CN]=编写新消息
Name[zh_TW]=寫一封新訊息
Exec=/opt/thunderbird/thunderbird -compose %u --class MozillaThunderbird
...
Name[zh_CN]=打开通讯录
Name[zh_TW]=開啟通訊錄
Exec=/opt/thunderbird/thunderbird -addressbook %u --class MozillaThunderbird" > Mozilla-Thunderbird.desktop ;
# Exit
exit 0
